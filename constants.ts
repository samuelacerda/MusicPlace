...
export const SEED_DATABASE = {
  ...
  products: [
    ...
    } as Product,
    {
        id: 'p6',
        userId: 'u3',
        title: 'Baixo Sire Marcus Miller V7 2nd Gen',
        price: 5800,
        images: ['https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?q=80&w=800&auto=format&fit=crop'],
        category: 'Baixos',
        subcategory: 'Baixos de 4 cordas',
        condition: Condition.NOVO,
        locationState: 'RJ',
        locationCity: 'Rio de Janeiro',
        description: 'Baixo Sire V7 Alder-4 Black 2nd Gen. Timbre matador e acabamento premium.',
        delivery: DeliveryMethod.AMBOS,
        sellerName: 'Music Shop Pro',
        sellerRating: 5.0,
        createdAt: new Date().toISOString(),
    ...
    } as Product,
    {
        id: 'p7',
        userId: 'u2',
        title: 'Violão Taylor 214ce Deluxe',
        price: 12500,
        images: ['https://images.unsplash.com/photo-1525201545678-146045bd1cbe?q=80&w=800&auto=format&fit=crop'],
        category: 'Violões',
        subcategory: 'Violões Eletroacústicos',
        condition: Condition.SEMINOVO,
        locationState: 'MG',
        locationCity: 'Belo Horizonte',
        description: 'Taylor 214ce Deluxe em estado de novo. Acompanha hard case original.',
        delivery: DeliveryMethod.RETIRADA,
        sellerName: 'João da Silva',
        sellerRating: 4.8,
        createdAt: new Date().toISOString(),
    ...
    } as Product,
    {
        ...
        price: 6900,
        images: ['https://images.unsplash.com/photo-1565965451305-2888e78b491a?q=80&w=800&auto=format&fit=crop'],
        category: 'Amplificadores',
        subcategory: 'Combos de Guitarra',
        condition: Condition.NOVO,
        locationState: 'SP',
        locationCity: 'São Paulo',
        description: 'Combo valvulado Marshall DSL40CR. Versatilidade total do clean ao high gain.',
        delivery: DeliveryMethod.ENVIO,
        sellerName: 'Music Shop Pro',
        sellerRating: 5.0,
        createdAt: new Date().toISOString(),
  ...
  settings: {
    ...
    // --- CONFIGURAÇÃO DE PAGAMENTO (ABACATE PAY) ---
    abacatePayApiKey: '',
    // ------------------------------------------
