...
import { User, Briefcase, Store, CheckCircle, ArrowRight, ArrowLeft } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  const completeRegistration = () => {
    ...
    const newUser: UserProfile = {
        ...
        plan: accountType === 'individual' ? undefined : selectedPlan
    };
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="email" name="email" value={formData.email} onChange={handleInputChange} className="w-full p-3 border border-gray-300 rounded-xl bg-white text-gray-900 focus:ring-2 focus:ring-brand-500 outline-none" required />
          </div>
          <div>
        ...
        <div className="pt-6">
          <button type="submit" className="w-full bg-brand-500 text-white font-bold py-4 rounded-xl hover:bg-brand-600 transition shadow-lg shadow-brand-500/20">
  ...
  const renderPlans = () => (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <ul className="space-y-3 text-sm text-gray-600 mb-8">
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> 5 anúncios mensais</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> Botão WhatsApp</li>
        ...
        >
          ...
          <ul className="space-y-3 text-sm text-gray-600 mb-8">
            ...
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> Destaque Prata</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> Estatísticas de venda</li>
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> Recomendações de IA</li>
          </ul>
        ...
        >
          ...
          <ul className="space-y-3 text-sm text-gray-600 mb-8">
            ...
            <li className="flex items-center gap-2"><CheckCircle size={16} className="text-brand-500" /> Destaque Ouro</li>
      ...
      <div className="mt-12 text-center">
        <button onClick={handleStep3Submit} className="bg-brand-500 text-white font-bold py-4 px-12 rounded-xl hover:bg-brand-600 transition shadow-lg shadow-brand-500/20 text-lg">
          Confirmar Assinatura e Criar Conta
        </button>
      </div>
    </div>
  );
